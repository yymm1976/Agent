...
import { memo, useState, useCallback, isValidElement, type ReactNode, type ComponentProps } from 'react';
...
// F-039/F-4.02：将 react-markdown 的 components prop 提取到模块作用域，
// 避免每次渲染都创建新的 components 对象（导致 react-markdown 内部 memo 失效）
...
// F-039/F-4.02：用 React.memo 包装导出组件
// props 仅 content: string（原始类型，引用稳定），memo 可有效阻止父组件重渲染时的连带重渲染
